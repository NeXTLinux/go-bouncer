	...
	docker run \
		...
		golang:latest \
			/bin/bash -x -c "\
				...
				./dist/go-bouncer_linux_amd64/bouncer list github.com/nextlinux/go-bouncer && \
				./dist/go-bouncer_linux_amd64/bouncer check github.com/nextlinux/go-bouncer \
			"
...
ci-test-linux-arm-run:
	...
	./dist/go-bouncer_linux_arm64/bouncer list github.com/nextlinux/go-bouncer

ci-test-mac-run:
	chmod 755 ./dist/go-bouncer_darwin_amd64/bouncer && \
	./dist/go-bouncer_darwin_amd64/bouncer version && \
	./dist/go-bouncer_darwin_amd64/bouncer list github.com/nextlinux/go-bouncer

ci-test-mac-arm-run:
	chmod 755 ./dist/go-bouncer_darwin_arm64/bouncer && \
	./dist/go-bouncer_darwin_arm64/bouncer version && \
	./dist/go-bouncer_darwin_arm64/bouncer list github.com/nextlinux/go-bouncer
